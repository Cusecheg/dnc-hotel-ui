...
import { getFormattedDetailedDate } from "@/helpers/format/data"
...
const ReservationOwnerListItem = ({ reservation }: ReservationOwnerListItemProps) => {
    ...
    return (
      <div className="flex w-full mt-5 md:mt-0">
        <div className="max-w-32 h-32">
          <Image
            src={reservation.user.avatar ? `/uploads/avatars/${reservation.user.avatar}` : "/default-profile.jpg"}
        ...
        <div className="w-full flex flex-col justify-between ml-4">
          ...
          {reservation.status === "PENDING" && (
            <div className="flex justify-around gap-4">
              ...
              <Button
                disabled={loading}
                onClick={handleReservationStatus("REJECTED")}
